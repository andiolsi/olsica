...
then
    ...
    chown "${OLSICA_TARGET_UID}:${OLSICA_TARGET_GID}" "${OLSICA_TARGET_DIRECTORY}/${OLSICA_TARGET_CLIENT_PKCS8_FILENAME}"
fi
...
then
    ...
    chown "${OLSICA_TARGET_UID}:${OLSICA_TARGET_GID}" "${OLSICA_TARGET_DIRECTORY}/${OLSICA_TARGET_CLIENT_KEYSTORE_FILENAME}"
fi
...
then
    ...
    chown "${OLSICA_TARGET_UID}:${OLSICA_TARGET_GID}" "${OLSICA_TARGET_DIRECTORY}/${OLSICA_TARGET_CLIENT_TRUSTSTORE_FILENAME}"
fi
